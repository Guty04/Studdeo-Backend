...
from app.schemas import CourseOdoo, SaleOdoo
...
@sale_router.get(path="/", response_model=List[SaleOdoo])
def route_get_sales_user(
    ...
    for course in courses:
        if course.product_id:
            sales.extend(course_service.get_course_sales(course_id=course.product_id))
